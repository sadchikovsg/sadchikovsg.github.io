...
- Полный отказ от Dokploy. Внедрен GitLab CI с Kaniko (вместо DinD).
...
| **Надежность** | 100% автоматизация настройки серверов (Ansible CI/CD Pipeline), 0 known bugs после релиза. |
